#!/usr/bin/env python3
"""Plot ICL accuracy against task examples on log and linear scales."""
...
DATA_DIR = REPO_ROOT / "src" / "local_data" / "icl_acc_results" / "fresh_frozen"
DEFAULT_OUTPUT = REPO_ROOT / "figures" / "acc_plot_fresh_frozen_two_panel.png"
RUNS = (
