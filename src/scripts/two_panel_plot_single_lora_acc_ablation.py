#!/usr/bin/env python3
"""Plot single-projection LoRA accuracy ablations on log and linear scales."""
...
DATA_DIR = REPO_ROOT / "src" / "local_data" / "icl_acc_results" / "single_lora_ablation"
DEFAULT_OUTPUT = REPO_ROOT / "figures" / "acc_plot_single_lora_ablation_two_panel.png"
RUNS = (
...
def make_figure(metric: str):
    ...
    axes[0].set(xscale="log", title="Log scale", ylabel="Accuracy")
    ...
    fig.suptitle("ICL Accuracy with a Single LoRA Projection Type")
    return fig
