...
from models.piano import PianoModel, PianoMode
from trainers.base_trainer import BaseTrainer
from utils.logging_utils import master_print
from utils.sharding_utils import maybe_shard_with_gradients


class PianoTrainer(BaseTrainer):
    ...
    def first_pass(
        ...
        self.model.update_state(        
            PianoMode.TRAIN_SECOND
            if update_second_mode
            else PianoMode.TRAIN_FIRST
        )
    ...
    def second_pass(
        ...
        with self._autocast():
            ...
            lm_states, _ = self.model.forward(
                input_ids=double_ids,
                shift_states=True,
                compute_logits=False,
                mode=PianoMode.TRAIN_SECOND,
                valid_mask=valid_mask,
            )
